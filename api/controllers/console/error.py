...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "AIs has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403


class NotSetupError(BaseHTTPException):
    error_code = 'not_setup'
    description = "AIs has not been initialized and installed yet. " \
