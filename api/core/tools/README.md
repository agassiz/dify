...
This module implements built-in tools used in Agent Assistants and Workflows within AIs. You could define and display your own tools in this module, without modifying the frontend logic. This decoupling allows for easier horizontal scaling of AIs's capabilities.
