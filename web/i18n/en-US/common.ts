const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'AIs account',
    langGeniusAccountTip: 'Your AIs account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to AIs to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by AIs allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across AIs\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'AIs {{version}} is now available.',
    latestAvailable: 'AIs {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
